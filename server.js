...
var db = mongoose.connect('mongodb://Areen:areen2104@ds219055.mlab.com:19055/nav-site');
var app = express();
...
app.route('/')
    .get(function (req, res, next) {
        res.send('nav-site  Backend - Server Is alive and kicking.!! ');
    });


app.listen(port, function () {
    console.log('----- nav-site  Backend Server running on port: ' + port);
});
